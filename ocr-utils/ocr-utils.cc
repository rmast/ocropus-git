...
namespace ocropus {
    ...
    void paint_box(bytearray &image, rectangle r, narray_byte color, bool inverted){
    ...
    void paint_box_border(bytearray &image, rectangle r, narray_byte color, bool inverted){
...
//         }
    ...
    template void remove_small_components<narray_byte>(narray<narray_byte> &,int,int);
    ...
    template void remove_marginal_components<narray_byte>(narray<narray_byte> &,int,int,int,int);
    ...
    template void rotate_90<narray_byte>(narray<narray_byte> &,narray<narray_byte> &);
    ...
    template void rotate_270<narray_byte>(narray<narray_byte> &,narray<narray_byte> &);
    ...
    template void rotate_180<narray_byte>(narray<narray_byte> &,narray<narray_byte> &);
    ...
    template void copy_rect<narray_byte>(narray<narray_byte> &,int,int,narray<narray_byte> &,int,int,int,int);
