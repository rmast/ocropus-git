...
namespace ocropus {
    ...
    struct SimpleGrouper : IGrouper {
        ...
        void extract(bytearray &out,bytearray &source,narray_byte dflt,int index,int grow=0) {
        ...
        void extractSliced(bytearray &out,bytearray &source,narray_byte dflt,int index,int grow=0) {
